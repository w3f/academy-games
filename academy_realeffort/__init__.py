...
class Player(BasePlayer):
    ...
    Kennwort = models.StringField(label="Bitte geben Sie hier Ihr Teilnahmekennwort ein")
    influencer = models.IntegerField(label="Bitte geben Sie hier an, wie viele Ihnen bekannte Influencer Sie gezählt haben", initial=0)
...
class Survey(Page):
    form_model = 'player'
    form_fields = ['Kennwort', 'influencer']
...
page_sequence = [Survey, Game, Results]
